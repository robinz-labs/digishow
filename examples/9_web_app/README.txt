...
3. In DigiShow's Interface Manager, set Virtual Pipe's "Remote Link Service" to "Enable (Multiple)". Then add an input signal to the signal link: Virtual Pipe → Binary → Channel 1.

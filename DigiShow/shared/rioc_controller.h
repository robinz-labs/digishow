...
#define RO_SENSOR_ENCODER_SET_RANGE_LOWER  0x05
#define RO_SENSOR_ENCODER_SET_RANGE_UPPER  0x06
...
#define RO_USER_CHANNEL_READ               0x01
#define RO_USER_CHANNEL_SET_NOTIFICATION   0x02
#define RO_USER_CHANNEL_NOTIFY             0x83
#define RO_USER_CHANNEL_WRITE              0x04
...
public:
    ...
    bool encoderWrite(unsigned char unit, unsigned char channel, int value = 0, bool wait = false);
    bool encoderSetRangeLower(unsigned char unit, unsigned char channel, int rangeLower);
    bool encoderSetRangeUpper(unsigned char unit, unsigned char channel, int rangeUpper);
    ...
    // user channels
    bool userChannelRead(unsigned char unit, unsigned char channel, int* pValue);
    bool userChannelSetNotification(unsigned char unit, unsigned char channel, bool enabled = true, int interval = 50);
    bool userChannelWrite(unsigned char unit, unsigned char channel, int value = 0, bool wait = false);
...
signals:
    ...
    void userChannelValueUpdated(unsigned char unit, unsigned char channel, int value);
